...
public class OAuth {
	private String oauth_consumer_key = "801143463";// AppKey(client credentials)	
	private String oauth_consumer_secret = "7acf95381485933af2ccb2fe2c57e604";// 签名密钥1
	...
	private String oauth_callback = "http://t.qq.com/yinhen3";// 认证成功后浏览器会被重定向到这个url中
